...
export function TitleBar() {
  ...
  return (
    <div className="flex items-center h-9 bg-card border-b select-none shrink-0 z-50">
      {/* Draggable branding area */}
      <div
        data-tauri-drag-region
        className="flex items-center gap-2 pl-3 h-full"
      >
      ...
      {/* Settings link — NOT inside drag region */}
      <NavLink
        to="/settings"
        className={({ isActive }) =>
      ...
      {/* Flexible drag spacer — fills remaining space */}
